...
<body>
 ...
 %></th>
	...
	<hr style="width: 100%">
	<form action="addressPaymentForOrederAction.jsp" method="post">
		<div class="left-div">
			<h3>Enter Address</h3>
		...
		<div class="right-div">
			<h3>Pay online on this onlinegroceryshop@pay.com</h3>
		...
		<div class="right-div">
			...
			</a><button class="button" type="submit"> <i class='far fa-arrow-alt-circle-right'> Proceed to Generate bill & save</i></button>
