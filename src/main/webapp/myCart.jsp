...
<body>
	<div style="color: white; text-align: center; font-size: 30px;">
		My Cart <i class="fa fa-cart-plus"></i>
	</div>
	...
	<table>
		...
		%>
			<tr>
				...
				<td><a href="incDecQuantityAction.jsp?id=<%=rs.getString(1) %>&quantity=inc"><i class="fa fa-plus-circle"></i></a><%=rs.getString(8) %> <a
					href="incDecQuantityAction.jsp?id=<%=rs.getString(1) %>&quantity=dec"><i class="fa fa-minus-circle"></i></a></td>
